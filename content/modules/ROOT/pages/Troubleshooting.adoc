...
[source,bash]
----
oc get pods -l app=llamastack-distribution-vllm
----
...
2. Make sure you're using the exact model ID from the list. The correct model for this workshop is `vllm/qwen3-14b-gaudi`.
...
[source,bash]
----
oc exec <llamastack-pod> -- df -h /home/lls/.lls
----
...
=== Issue: I'm getting "ModuleNotFoundError: No module named 'llama_stack_client'" or similar import errors
...
2. Verify the packages are installed:
+
[source,bash]
----
pip list | grep llama
...
4. If you're in the wrong directory, navigate to the correct project folder:
+
[source,bash]
----
